...
## Project Structure
    ...
    ├── car_dealership_exam_43790  # Django project configurations
...
1. Clone this repo and `cd car_dealership_exam_43790`
...
2. Clone this repo and `cd car_dealership_exam_43790`
